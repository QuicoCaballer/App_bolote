...
# CSS para forzar columnas y botones en línea
st.markdown("""
<style>
/* Contenedor principal de columnas: flex horizontal, sin apilar en móvil */
...
/* Inputs más estrechos y centrados */
div[data-baseweb="input"] input {
    max-width: 80px !important;
    text-align: center;
}

/* Botones en fila con espacio y tamaño reducido */
.compact-buttons {
    display: flex;
    flex-wrap: wrap;
    gap: 5px;
